/**************************************************************************//**
 * @file     FlashPrg.c
 * @brief    Flash Programming Functions adapted for RA6M5
 * @version  V1.0.2
 * @date     15 Feb 2024
 ******************************************************************************/
/*
 ...
 *         : 15.07.2021 1.0.0    First Release
 *         : 11.04.2022 1.0.1    Fixed a bug that the data flash area could not be rewritten
 *				 : 15.02.2024 1.0.2		 Increase Programming Page Size
 *********************************************************************************************************************/
/** FlashOS Structures */
#include "../FlashOS.h"
...
#ifdef RA6M5_2M
#define CODEF_32K_BLOCK_NUM     (0x3E)
#define DATAF_64B_BLOCK_NUM     (0x80)
#endif
#ifdef RA6M5_2M_dual_lower
#define CODEF_32K_BLOCK_NUM     (0x1E)
#define DATAF_64B_BLOCK_NUM     (0x80)
#endif
#ifdef RA6M5_2M_dual_upper
#define CODEF_32K_BLOCK_NUM     (0x1E)
#define DATAF_64B_BLOCK_NUM     (0x80)
#endif
#ifdef RA6M5_1_dot_5M
#define CODEF_32K_BLOCK_NUM     (0x2E)
#define DATAF_64B_BLOCK_NUM     (0x80)
#endif
#ifdef RA6M5_1_dot_5M_dual_lower
#define CODEF_32K_BLOCK_NUM     (0x16)
#define DATAF_64B_BLOCK_NUM     (0x80)
#endif
#ifdef RA6M5_1_dot_5M_dual_upper
#define CODEF_32K_BLOCK_NUM     (0x16)
#define DATAF_64B_BLOCK_NUM     (0x80)
#endif
#ifdef RA6M5_1M
...
#define DATAF_64B_BLOCK_NUM     (0x80)
#endif
#ifdef RA6M5_1M_dual_lower
#define CODEF_32K_BLOCK_NUM     (0x0E)
#define DATAF_64B_BLOCK_NUM     (0x80)
#endif
#ifdef RA6M5_1M_dual_upper
#define CODEF_32K_BLOCK_NUM     (0x0E)
#define DATAF_64B_BLOCK_NUM     (0x80)
#endif
#ifdef RA6M5_DATA
...
int EraseChip (void)
{
	...
	uword_t uw_block_add_num;	// Number of additional blocks in dual mode
    uword_t i;
