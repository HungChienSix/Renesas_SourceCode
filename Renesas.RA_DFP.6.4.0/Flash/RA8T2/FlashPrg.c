/**************************************************************************//**
 * @file     FlashDev.c
 * @brief    Flash Device Description for RA8T2
 * @version  V1.0.0
 * @date     31 Dec 2025
 ******************************************************************************/
/*
...
#ifdef RA8T2_CONF //The Configuration area does not support Erase, the default number for blocks 32KB is 0.
	#define CODEMRAM_32K_BLOCK_NUM      (0x00)
	#undef READ_DATA_SIZE               // Undef macro first
	#define READ_DATA_SIZE              (64)
#endif

#ifdef RA8T2_OTP //The OTP area does not support Erase, the default number for blocks 32KB is 0.
	#define CODEMRAM_32K_BLOCK_NUM      (0x00)
	#undef READ_DATA_SIZE               // Undef macro first
	#define READ_DATA_SIZE              (64)
#endif
...
#if (defined RA8T2_SiP_8M) || (defined RA8T2_SiP_4M)
...
{
#if (defined RA8T2_CONF) || (defined RA8T2_OTP) 
