...
struct FlashDevice const FlashDevice  =  {
   ...
   "RA8T2 512KB Code MRAM",    // Device Name 
   ONCHIP,                     // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA8T2 1M Code MRAM",       // Device Name 
   ONCHIP,                     // Device Type
   0x02000000,                 // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA8T2 Extra MRAM Config area",        // Device Name 
   ONCHIP,                     // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA8T2 Extra MRAM OTP area",// Device Name 
   ONCHIP,                     // Device Type
