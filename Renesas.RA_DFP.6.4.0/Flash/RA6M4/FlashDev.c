/**************************************************************************//**
 * @file     FlashDev.c
 * @brief    Flash Device Description for RA6M4
 * @version  V1.0.3
 * @date     14 May 2024
 ******************************************************************************/
/*
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA6M4 512K Flash(dual lower side)",   // Device Name 
   ONCHIP,                     // Device Type
   0x00000000,                 // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA6M4 512K Flash(dual upper side)",   // Device Name 
   ONCHIP,                     // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA6M4 768K Flash(dual lower side)",   // Device Name 
   ONCHIP,                     // Device Type
   0x00000000,                 // Device Start Address
   0x00060000,                 // Device Size in Bytes (768KB/2)
   8192,                       // Programming Page Size
   0,                          // Reserved, must be 0
   0xFF,                       // Initial Content of Erased Memory
   1000,                       // Program Page Timeout 1000 mSec
...
// Specify Size and Address of Sectors
   0x00002000, 0x00000000,     // Sector Size  8kB (8 Sectors)
   0x00008000, 0x00010000,     // Sector Size 32kB (10 Sectors)
   SECTOR_END
};
#endif
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA6M4 768K Flash(dual upper side)",   // Device Name 
   ONCHIP,                     // Device Type
   0x00200000,                 // Device Start Address
   0x00060000,                 // Device Size in Bytes (768KB/2)
   8192,                       // Programming Page Size
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA6M4 1M Flash(dual lower side)",   // Device Name 
   ONCHIP,                     // Device Type
   0x00000000,                 // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA6M4 8KB DataFlash",      // Device Name 
   ONCHIP,                     // Device Type
