/**************************************************************************//**
 * @file     FlashDev.c
 * @brief    Flash Device Description for RA0L1
 * @version  V1.0.0
 * @date     31 Jan 2025
 ******************************************************************************/
/*
 ...
 *         : 31.01.2025 1.0.0    First Release
 *********************************************************************************************************************/
...
struct FlashDevice const FlashDevice  =  {
	FLASH_DRV_VERS,								// Driver Version, do not modify!
	"RA0L1 1KB DataFlash",				// Device Name 
	ONCHIP,												// Device Type
