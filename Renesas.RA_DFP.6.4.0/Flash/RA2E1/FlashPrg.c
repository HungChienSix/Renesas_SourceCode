/**************************************************************************//**
 * @file     FlashPrg.c
 * @brief    Flash Programming Functions adapted for RA2E1
 * @version  V1.0.4
 * @date     27 March 2024
 ******************************************************************************/
/*
 ...
 *         : 18.02.2022 1.0.1    Fixed a bug that the configlation area could not be rewritten		
 *         : 28.03.2022 1.0.2    Implemented source code improvements
 *         : 06.02.2024 1.0.3    Increase Programming PageSize
 *         : 27.03.2024 1.0.4    Modify Programming PageSize (Code/Data 2KB/1KB)
 *********************************************************************************************************************/
...
#define CODEF_SIZE											(0x00020000) // Should re-define this value base on user's marco
#define DATAF_SIZE											(0x00001000) // Should re-define this value base on user's marco
