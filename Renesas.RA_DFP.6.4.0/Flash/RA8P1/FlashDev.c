/**************************************************************************//**
 * @file     FlashDev.c
 * @brief    Flash Device Description for RA8P1
 * @version  V1.0.0
 * @date     31 Dec 2025
 ******************************************************************************/
/*
...
struct FlashDevice const FlashDevice  =  {
   ...
   "RA8P1 512KB Code MRAM",    // Device Name 
   ONCHIP,                     // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA8P1 1M Code MRAM",       // Device Name 
   ONCHIP,                     // Device Type
   0x02000000,                 // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA8P1 Extra MRAM Config area",        // Device Name 
   ONCHIP,                     // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA8P1 Extra MRAM OTP area",// Device Name 
   ONCHIP,                     // Device Type
