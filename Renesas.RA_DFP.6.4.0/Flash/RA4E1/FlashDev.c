/**************************************************************************//**
 * @file     FlashDev.c
 * @brief    Flash Device Description for RA4E1
 * @version  V1.0.3
 * @date     14 May 2024
 ******************************************************************************/
/*
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA4E1 8KB DataFlash",      // Device Name 
   ONCHIP,                     // Device Type
