/**************************************************************************//**
 * @file     FlashDev.c
 * @brief    Flash Device Description for RA8E1
 * @version  V1.0.0
 * @date     31 Aug 2024
 ******************************************************************************/
/*
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA8E1 1M Flash(dual lower side)",   // Device Name 
   ONCHIP,                     // Device Type
   0x02000000,                 // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA8E1 1M Flash(dual upper side)",   // Device Name 
   ONCHIP,                     // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA8E1 12KB DataFlash",     // Device Name 
   ONCHIP,                     // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA8E1 Code flash Config area",        // Device Name 
   ONCHIP,                     // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA8E1 Data flash Config area",        // Device Name 
   ONCHIP,                     // Device Type
