/**************************************************************************//**
 * @file     FlashDev.c
 * @brief    Flash Device Description for RA4M3
 * @version  V1.0.3
 * @date     14 May 2024
 ******************************************************************************/
/*
 ...
 *				 : 14.05.2024	1.0.3		 Modidy Configuration Area Size
 *********************************************************************************************************************/
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA4M3 8KB DataFlash",      // Device Name 
   ONCHIP,                     // Device Type
