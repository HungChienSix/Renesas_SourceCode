/**************************************************************************//**
 * @file     FlashDev.c
 * @brief    Flash Device Description for RA2E2
 * @version  V1.0.2
 * @date     28 March 2024
 ******************************************************************************/
/*
 ...
 *         : 28.03.2024 1.0.2    Modify Programming Page Size (Code/Data - 1KB/1KB)
 *********************************************************************************************************************/
...
struct FlashDevice const FlashDevice  =  {
	FLASH_DRV_VERS,								// Driver Version, do not modify!
	"RA2E2 2KB DataFlash",				// Device Name 
	ONCHIP,												// Device Type
...
// Specify Size and Address of Sectors
	0x00000400, 0x00000000,				// Sector Size 1KB (2 Sectors)
	SECTOR_END
};
#endif
