/**************************************************************************//**
 * @file     FlashDev.c
 * @brief    Flash Device Description for RA0E2
 * @version  V1.0.0
 * @date     31 Jul 2024
 ******************************************************************************/
/*
 ...
 *         : 31.07.2024 1.0.0    First Release
 *********************************************************************************************************************/
...
struct FlashDevice const FlashDevice  =  {
	FLASH_DRV_VERS,								// Driver Version, do not modify!
	"RA0E2 2KB DataFlash",				// Device Name 
	ONCHIP,												// Device Type
