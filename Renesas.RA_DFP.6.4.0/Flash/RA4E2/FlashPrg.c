/**************************************************************************//**
 * @file     FlashPrg.c
 * @brief    Flash Programming Functions adapted for RA4E2
 * @version  V1.0.1
 * @date     16 Feb 2024
 ******************************************************************************/
/*
 ...
 *         : 18.01.2023 1.0.0    First Release	
...
#ifdef RA4E2_128K
    #define CODEF_32K_BLOCK_NUM   (0x2)
    #define DATAF_64B_BLOCK_NUM   (0x40)
#endif
#ifdef RA4E2_DATA
    #define CODEF_32K_BLOCK_NUM   (0x2)
    #define DATAF_64B_BLOCK_NUM   (0x40)
...
int UnInit (unsigned long fnc)
{
    ...
    M16(MCU_FPCKAR_ADDR) = FPCKAR_KEY | (uword_t)s_udwClockUserVal[SCKSCR];
...
int BlankCheck (unsigned long adr, unsigned long sz, unsigned char pat)
{
    ...
    // Detect Area
    if (adr < MCU_FENTRYD_CMPADDR)
    {
        // This is Code flash and Configuration Area
...
* @param[in] sz:   Page Size
* @param[in] buf:  Page Data
* @retval    (adr + sz) - OK,  1 - Failed (Represent the failing address)
******************************************************************************/
