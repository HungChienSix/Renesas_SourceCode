/**************************************************************************//**
 * @file     FlashPrg.c
 * @brief    Flash Programming Functions adapted for RA4L1
 * @version  V1.0.0
 * @date     27 May 2024
 ******************************************************************************/
/*
...
int EraseChip (void)
{
    ...
    return (RES_OK); // OK
		...
		#if (defined CODE_512K_dual) || (defined CODE_256K_dual) || (defined RA4L1_512K_dual_lower) || (defined RA4L1_512K_dual_upper) || (defined RA4L1_256K_dual_lower) || (defined RA4L1_256K_dual_upper)
		// Clear Code flash
