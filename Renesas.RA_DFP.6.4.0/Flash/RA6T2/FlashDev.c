/**************************************************************************//**
 * @file     FlashDev.c
 * @brief    Flash Device Description for RA6T2
 * @version  V1.0.3
 * @date     14 May 2024
 ******************************************************************************/
/*
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "RA6T2 16KB DataFlash",     // Device Name 
   ONCHIP,                     // Device Type
...
// Specify Size and Address of Sectors
   0x00000040, 0x00000000,     // Sector Size  64B (256 Sectors)
   SECTOR_END
};
#endif
