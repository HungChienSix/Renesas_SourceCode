/**************************************************************************//**
 * @file     FlashPrg.c
 * @brief    Flash Programming Functions adapted for RA8M1
 * @version  V1.0.1
 * @date     06 Feb 2024
 ******************************************************************************/
/*
...
#ifdef RA8M1_CCONF //The Configuration area does not support Erase, the default number for blocks 8KB and 32KB is 0. 
	#define CODEF_32K_BLOCK_NUM     			(0x0)
	#define DATAF_64B_BLOCK_NUM     			(0x0)
#endif

#ifdef RA8M1_DCONF //The Configuration area does not support Erase, the default number for blocks 8KB and 32KB is 0. 
	#define CODEF_32K_BLOCK_NUM     			(0x0)
	#define DATAF_64B_BLOCK_NUM     			(0x0)
#endif
...
#if (defined RA8M1_CCONF) || (defined RA8M1_DCONF) 
