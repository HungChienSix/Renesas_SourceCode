/**************************************************************************//**
 * @file     FlashDev.c
 * @brief    Flash Device Description for RA2E3
 * @version  V1.0.1
 * @date     07 Mar 2024
 ******************************************************************************/
/*
...
struct FlashDevice const FlashDevice  =  {
	FLASH_DRV_VERS,								// Driver Version, do not modify!
	"RA2E3 2KB DataFlash",				// Device Name 
	ONCHIP,												// Device Type
