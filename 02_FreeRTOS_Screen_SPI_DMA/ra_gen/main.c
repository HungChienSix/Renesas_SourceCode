...
#include "task.h"
#include "semphr.h"
extern void uart_debug_thread_create(void);
extern TaskHandle_t uart_debug_thread;
extern void spi_screen_thread_create(void);
extern TaskHandle_t spi_screen_thread;
...
int main(void)
{
    ...
    /* Init RTOS tasks. */
    uart_debug_thread_create ();
    spi_screen_thread_create ();
