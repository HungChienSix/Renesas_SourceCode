...
#define VECTOR_NUMBER_DMAC0_INT ((IRQn_Type) 1) /* DMAC0 INT (DMAC0 transfer end) */
#define DMAC0_INT_IRQn          ((IRQn_Type) 1) /* DMAC0 INT (DMAC0 transfer end) */
#define VECTOR_NUMBER_SCI2_RXI ((IRQn_Type) 2) /* SCI2 RXI (Receive data full) */
#define SCI2_RXI_IRQn          ((IRQn_Type) 2) /* SCI2 RXI (Receive data full) */
