...
#define LCD_SCK_GPIO_CLK    RCC_APB2Periph_GPIOG

#define LCD_MOSI_GPIO_PORT   GPIOD
#define LCD_MOSI_GPIO_PIN    GPIO_Pin_5
#define LCD_MOSI_GPIO_CLK    RCC_APB2Periph_GPIOD

#define LCD_RES_GPIO_PORT   GPIOD
#define LCD_RES_GPIO_PIN    GPIO_Pin_4
#define LCD_RES_GPIO_CLK    RCC_APB2Periph_GPIOD

#define LCD_DC_GPIO_PORT    GPIOD
#define LCD_DC_GPIO_PIN     GPIO_Pin_15
#define LCD_DC_GPIO_CLK     RCC_APB2Periph_GPIOD
