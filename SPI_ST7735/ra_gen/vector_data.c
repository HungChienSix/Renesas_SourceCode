...
/* Do not build these data structures if no interrupts are currently allocated because IAR will have build errors. */
        ...
        {
                        [0] = sci_spi_rxi_isr, /* SCI2 RXI (Receive data full) */
            [1] = sci_spi_txi_isr, /* SCI2 TXI (Transmit data empty) */
            [2] = sci_spi_tei_isr, /* SCI2 TEI (Transmit end) */
            [3] = sci_spi_eri_isr, /* SCI2 ERI (Receive error) */
